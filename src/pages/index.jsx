...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href="https://docs.google.com/document/d/1Wnzl_R2KCcNHyW4RxXxyC-8uH1oFWinYet5x-5UgsTY/edit?usp=sharing"
        variant="secondary"
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>Farhan Helmy - Software Engineer</title>
